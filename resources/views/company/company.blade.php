    ...
    <div class="container mx-auto px-12 max-w-screen-xl">
        <div class="pt-20 pb-8">
            <div class="bg-gradient-to-r from-blue-600 to-transparent rounded-lg mb-8 p-6">
                <h2 class="text-2xl font-bold text-white mb-2">Guest Profile : Group</h2>
                <p class="text-white">Kelola Informasi Tamu Group</p>
            </div>
            ...
            <div class="max-w-6xl mx-auto flex items-center gap-4">
                ...
                <!-- Add Button -->
                <button type="button" data-modal-target="crud-add-group" data-modal-toggle="crud-add-group"
                ...
                <div id="crud-add-group" tabindex="-1" aria-hidden="true"
